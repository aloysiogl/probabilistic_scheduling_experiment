...
class DualDurationTask(Task):
    def __init__(self, period, duration_smaller, duration_larger, on_done=None, deadline_miss_callback=None):
        super().__init__(period, duration_smaller, on_done, deadline_miss_callback)
