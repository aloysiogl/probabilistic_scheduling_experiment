...
class DualDurationTask(Task):
    def __init__(self, period, duration_smaller, duration_larger, arrival_time=0, on_done=None, deadline_miss_callback=None, name=None):
        super().__init__(period, duration_smaller, arrival_time, on_done, deadline_miss_callback, name)
